...
def editar_perfil(request, username):
    ...
    #print(f'editar_perfil -> request.user.username: {request.user.username}')
    #print(f'editar_perfil -> request.user.is_superuser: {request.user.is_superuser}')
    #print(f'editar_perfil -> request.user.groups.all(): {request.user.groups.all()}')
